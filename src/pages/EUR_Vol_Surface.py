...
#implied vol zscore
dfzs = pd.read_excel(r"C:\Users\charl\Documents\master.xlsx", sheet_name='VolGrid',header=[0,1],index_col=[0])
dfzs = dfzs.tail(-1)
dfzs= dfzs.ffill()
...
#daily implied vol
dfdvol = pd.read_excel(r"C:\Users\charl\Documents\master.xlsx", sheet_name='VolGrid',header=[0,1],index_col=[0])
...
#1m lookback vol
dfvol1m = pd.read_excel(r"C:\Users\charl\Documents\master.xlsx", sheet_name='VolGrid',header=[0,1],index_col=[0])
...
#1m lookback swap
dfswap1m = pd.read_excel(r"C:\Users\charl\Documents\master.xlsx", sheet_name='FwdGrid',header=[0,1],index_col=[0])
...
#3m lookback vol
dfvol3m = pd.read_excel(r"C:\Users\charl\Documents\master.xlsx", sheet_name='VolGrid',header=[0,1],index_col=[0])
...
#3m lookback swap
dfswap3m = pd.read_excel(r"C:\Users\charl\Documents\master.xlsx", sheet_name='FwdGrid',header=[0,1],index_col=[0])
